...
public class AgencyOperationConsumer extends DefaultConsumer {
	...
	public void handleDelivery(String consumerTag, Envelope envelope, BasicProperties properties, byte[] body) throws IOException {
		...
		case GET_TYPES: {
			...
			break;
		case DELIVER_TYPES:
			operation.addTypes(message, channel, properties);
			break;
		case GET_RUNNING: {
			try {
			...
			break;
		case ROLLBACK:
			operation.rollback(message, channel, mapper, properties);
			break;
		case DELETE_AGENT:
			operation.deleteRunningAgent(message, channel, properties);
			break;
		case ADD_AGENT:
			operation.addAgent(message, channel, properties);
			break;
		case RUN_AGENT:
			operation.runAgent(message, channel, properties);
			break;
		case STOP_AGENT:
